...
// This will fail CI, since this code can't be upstreamed in current form

/**
 * Code to setup SEMC for SDRAM usage, useful when you don't want a
 * DCD, or want better control over the SDRAM configuration.
 * This file must run from ITCM or from FLEXSPI, NOT SDRAM.
 */

static void board_semc_config()
{
    ...
    sdramconfig.burstLen = kSEMC_Sdram_BurstLen1; /* Set to 1 according to ERR050577 */
